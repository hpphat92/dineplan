...
namespace DinePlan.DineConnect.Tests.Authorization.Users
{
    public class UserAppService_Link_Tests : UserAppServiceTestBase
    {
        ...
        private async Task CreateTestTenantAndTestUser()
        {
            ...
            {
                ConnectionString = SimpleStringCipher.Instance.Encrypt("Server=localhost; Database=DineConnectTest_" + Guid.NewGuid().ToString("N") + "; Trusted_Connection=True;")
            };
