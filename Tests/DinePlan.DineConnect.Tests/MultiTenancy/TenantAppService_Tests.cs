...
namespace DinePlan.DineConnect.Tests.MultiTenancy
{
        ...
        public async Task Create_Update_And_Delete_Tenant_Test()
        {
            ...
            await _tenantAppService.CreateTenant(
                new CreateTenantInput
                {
                    ...
                    IsActive = true,
                    ConnectionString = "Server=localhost; Database=DineConnectTest_" + Guid.NewGuid().ToString("N") + "; Trusted_Connection=True;"
                });
