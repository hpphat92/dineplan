...
namespace DinePlan.DineConnect.Authorization
{
    ...
    public class AppAuthorizationProvider : AuthorizationProvider
    {
        ...
        public override void SetPermissions(IPermissionDefinitionContext context)
        {
            ...
            var xeroPermission =
                masterHousePermission.CreateChildPermission(AppPermissions.Pages_Tenant_House_Master_Xero,
        L("Xero"), multiTenancySides: MultiTenancySides.Tenant);
            xeroPermission.CreateChildPermission(AppPermissions.Pages_Tenant_House_Master_Xero_Delete,
                L("DeleteXero"), multiTenancySides: MultiTenancySides.Tenant);
            xeroPermission.CreateChildPermission(AppPermissions.Pages_Tenant_House_Master_Xero_Edit,
                L("EditXero"), multiTenancySides: MultiTenancySides.Tenant);
            xeroPermission.CreateChildPermission(AppPermissions.Pages_Tenant_House_Master_Xero_Create,
                L("CreateXero"), multiTenancySides: MultiTenancySides.Tenant);
