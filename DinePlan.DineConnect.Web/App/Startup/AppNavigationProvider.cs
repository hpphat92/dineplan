    ...
    public class AppNavigationProvider : NavigationProvider
    {
        public override void SetNavigation(INavigationProviderContext context)
        {
            context.Manager.MainMenu
                ...
                .AddItem(new MenuItemDefinition(PageNames.App.Tenant.Dashboard, L("House"), "fa fa-th",
                        requiredPermissionName: AppPermissions.Pages_Tenant_Dashboard)
                        ...
                        .AddItem(new MenuItemDefinition(PageNames.App.DineHouse.Master, L("Master"), "fa fa-indent",
                            ...
                            .AddItem(new MenuItemDefinition(PageNames.App.DineHouse.Supplier, L("Supplier"),
                                ...
                                requiredPermissionName: AppPermissions.Pages_Tenant_House_Master_Xero))
                                 .AddItem(new MenuItemDefinition(PageNames.App.DineHouse.Xero, L("Xero"),
                                "fa fa-skyatlas", "tenant.xero",
                                requiredPermissionName: AppPermissions.Pages_Tenant_House_Master_Xero))
                  ))
                  .AddItem(new MenuItemDefinition(
